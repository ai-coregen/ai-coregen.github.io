...
export const solution = {
  ...
  heading: "私たちの理念",
  body: [
    "他社は業務効率化だけ。私たちは、ただ業務効率化で終わらせず、売上を最大化させることにコミットします。",
    "AIを単なる業務効率化に終わらせるのではなく、売上を上げるためのAI活用を組織に実装します。",
    "AI活用は、まずはAI人材の育成から。",
  ],
  flowSteps: [
    "AIで業務効率化",
    "コスト削減",
    "新規事業の創出 / 売上部門への人員配置転換",
    "売上・利益の最大化",
  ],
  closing:
...
export const profile = {
  ...
  career: [
    ...
    "はなさく生命保険にて営業企画部門で新規マーケット開拓を担当。2025年4月にAIビジネスをゼロから開始し、現在AIコンサルタントとして活動。",
  ],
  stats: [
    { value: "1,000+", label: "名の営業組織マネジメント" },
    { value: "35億", label: "円まで売上を拡大" },
...
export const curriculum = {
  ...
  intro:
    "全社的なAIリテラシー向上と、業務効率化に直結するAIスキル・知識を完全習得していただきます。",
  ...
  closing:
    "基礎動画学習 ＋ カスタマイズワークショップ ＋ 伴走支援 で、AIスキルと知識を習得＝AIを組織に完全実装。",
  cta: "カリキュラム詳細資料をダウンロード",
};
